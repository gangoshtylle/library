    ...
    public partial class ViewStudentInformation : Form
    {
        ...
        private void txtSearchEnrollement_TextChanged(object sender, EventArgs e)
        {
            if (txtSearchEnrollement.Text != "")
            {
                ...
                Image image = Image.FromFile("C:\\Users\\Eljon\\Downloads\\Liberay Management System Icon and Images\\Liberay Management System\\search1.gif");
            ...
            {
                label1.Visible = true;
                Image image = Image.FromFile("C:\\Users\\Eljon\\Downloads\\Liberay Management System Icon and Images\\Liberay Management System\\search.gif");
                pictureBox1.Image = image;
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmd.CommandText = " select * from stuid=" + bid + "";
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Data will be Updated. Confirm?", "Success", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                cmd.CommandText = "update NewStudent set sname ='" + sname + "',enroll='" + enroll + "',dep='" + department + "',sem='" + sem + "',contact='" + contact + "',email='" + semail + "' where stuid = " + rowid + "    ";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
